...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/otc/otc-settings.inc');
}

// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tags.
// This section is autogenerated by Acquia Dev Desktop.
//if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_otc_dev_default.inc')) {
...
$settings['trusted_host_patterns'] = array(
'^cl-drupal.orientaltrading.com$',
'^prod-drupal-alb-external-927111708.us-west-2.elb.amazonaws.com$'
//  '^.*.dev.dd$',
//  '^.*orientaltrading.com$',
